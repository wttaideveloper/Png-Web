import { BarChart3, ImageIcon, Target, Type } from "lucide-react";
      ...
      <SectionLayout
        ...
        previewColumn={
          <PreviewPanel footnote="Stats preview shows up to four items.">
            <div
              className="admin-mission-preview"
              style={imageUrl ? { backgroundImage: `linear-gradient(rgba(7,43,82,0.9), rgba(7,43,82,0.9)), url(${imageUrl})`, backgroundSize: "cover" } : undefined}
            >
